...
#define   VO_BASE_ADDR  0x11000000
...
#define LAYER_VHD_START  HAL_DISP_LAYER_VHD1  //VHD1
...
#define LAYER_GFX_START  HAL_DISP_LAYER_GFX2  //GFX2
#define LAYER_GFX_END    HAL_DISP_LAYER_GFX2  //GFX2
