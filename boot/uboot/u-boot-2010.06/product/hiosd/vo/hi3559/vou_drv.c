...
HI_VOID VOU_DRV_DateSetting(VO_DEV VoDev, VO_INTF_SYNC_E enOutSync)
{
    ...
    switch (enOutSync)
    {
        case VO_OUTPUT_PAL :
            ...
            HAL_DISP_SetDateCoeffByIdx(22, 0xa2);
            HAL_DISP_SetDateCoeffByIdx(50, 0x7fb);
            HAL_DISP_SetDateCoeffByIdx(51, 0x20a);
            HAL_DISP_SetDateCoeffByIdx(52, 0x7fb);
            HAL_DISP_SetDateCoeffByIdx(53, 0x7aa0011);
            HAL_DISP_SetDateCoeffByIdx(54, 0x1450145);
            HAL_DISP_SetDateCoeffByIdx(55, 0x1107aa);
            HAL_DISP_SetDateCoeffByIdx(57, 0x80828282);
            break;
        case VO_OUTPUT_NTSC :
            HAL_DISP_SetDateCoeffByIdx(22, 0xa2);
            HAL_DISP_SetDateCoeffByIdx(24, 0x12099);
            HAL_DISP_SetDateCoeffByIdx(50, 0x7fb);
            HAL_DISP_SetDateCoeffByIdx(51, 0x20a);
            HAL_DISP_SetDateCoeffByIdx(52, 0x7fb);
            HAL_DISP_SetDateCoeffByIdx(53, 0x7aa0011);
            ...
            HAL_DISP_SetDateCoeffByIdx(55, 0x1107aa);
            HAL_DISP_SetDateCoeffByIdx(57, 0x80828282);
            HAL_DISP_SetDateCoeffByIdx(61, 0x1);
            u32Data = 0x108410dc;
            HAL_DISP_SetDateCoeffByIdx(60, 0);
            break;
...
{
    *penIntfType = g_stHalDevCfg[VoDev].enIntfType;
}
...
HI_VOID VOU_DRV_Open(VO_DEV VoDev)
{
    ...
    if (VO_INTF_LCD_8BIT & g_stHalDevCfg[VoDev].enIntfType
    || VO_INTF_LCD_6BIT & g_stHalDevCfg[VoDev].enIntfType
    || VO_INTF_LCD_16BIT & g_stHalDevCfg[VoDev].enIntfType)
    {
        SYS_HAL_VouLcdClkEn(VoDev, bClkEn);
    }
    ...
    if (VO_INTF_LCD & g_stHalDevCfg[VoDev].enIntfType
        || VO_INTF_LCD_6BIT & g_stHalDevCfg[VoDev].enIntfType
        || VO_INTF_LCD_8BIT & g_stHalDevCfg[VoDev].enIntfType
        || VO_INTF_LCD_16BIT & g_stHalDevCfg[VoDev].enIntfType
    )
    {
        stBkg.u8Bkg_y  = RGB_R(g_stHalDevCfg[VoDev].u32BkGrd);
        stBkg.u8Bkg_cb = RGB_G(g_stHalDevCfg[VoDev].u32BkGrd);
        stBkg.u8Bkg_cr = RGB_B(g_stHalDevCfg[VoDev].u32BkGrd);

    }
    else
    {
        u32YuvBkGrd    = Rgb2Yuv(g_stHalDevCfg[VoDev].u32BkGrd);
    ...
    {   
        HAL_DISP_SetIntfMuxSel(VoDev, g_stHalDevCfg[VoDev].enIntfType);
        HAL_DISP_SetIntfSyncInv(g_stHalDevCfg[VoDev].enIntfType, &stInv);
        if (VO_OUTPUT_320X240_60 == g_stHalDevCfg[VoDev].enOutSync)
        {
        ...
        else if (VO_OUTPUT_320X240_50== g_stHalDevCfg[VoDev].enOutSync)
        {
            LCD_CTRL.bits.lcd_serial_mode    = 1;
        ...
        else if (VO_OUTPUT_240X320_50 == g_stHalDevCfg[VoDev].enOutSync)
        {
            LCD_CTRL.bits.lcd_serial_mode    = 1;
            LCD_CTRL.bits.lcd_serial_perd    = 0;
            LCD_CTRL.bits.lcd_parallel_order = 0;
        ...
        else if (VO_OUTPUT_240X320_60 == g_stHalDevCfg[VoDev].enOutSync)
        {
        ...
        HAL_DISP_SetIntfCtrl(g_stHalDevCfg[VoDev].enIntfType, &(LCD_CTRL.u32));
    }
    ...
    {
        HAL_DISP_SetVtThdMode(VoDev, VOU_INT_MODE_FRAME);
        HAL_VIDEO_SetLayerUpMode(VoDev, VOU_INT_MODE_FRAME);
    }
...
HI_VOID VOU_DRV_Close(HI_S32 VoDev)
{
    ...
    if (VO_INTF_CVBS & g_stHalDevCfg[VoDev].enIntfType)
    {
        ...
        HAL_DISP_SetIntfDacChnEnable(VO_INTF_CVBS, HI_FALSE);
        SYS_HAL_VouOutClkEn(VoDev, bClkEn);
    }
