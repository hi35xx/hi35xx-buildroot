...
typedef union
{
    ...
    struct
    {
        ...
        HI_U32    video_acc_upd         : 1   ; // [4]
        HI_U32    dhd_gamma_upd         : 1   ; // [5]
...
typedef struct
{
    ...
    U_VHDP15VLPOS        VHDP15VLPOS;
    HI_U32         Reserved_33[2];
    ...
    U_VSD1CBMPARA        VSD1CBMPARA;
    HI_U32         Reserved_284[10];
    U_VSD1DFPOS          VSD1DFPOS;
    ...
    U_VSD116REGIONEN     VSD116REGIONEN;
    ...
    U_CBMATTR            CBMATTR;
    U_CBMMIX1            CBMMIX1;
    HI_U32         Reserved_CBMMIX2;                   //9E18  ±£¡Ù≤ª”√
    ...
    U_DHDCLIPL           DHDCLIPL;
    U_DHDCLIPH           DHDCLIPH;
    HI_U32         Reserved_465[14];
    HI_U32         Reserved_DHDCCDOIMGMOD;
    HI_U32         Reserved_DHDCCDOPOSMSKH;
    HI_U32         Reserved_DHDCCDOPOSMSKL;
    HI_U32         Reserved_466;
    HI_U32         Reserved_DHDCCDIIMGMOD;
    HI_U32         Reserved_DHDCCDIPOSMSKH;
    HI_U32         Reserved_DHDCCDIPOSMSKL;
    HI_U32         Reserved_ed_467[21];
    U_DHDSTATE               DHDSTATE;
