...
#define VO_WBC_MAX_WIDTH        1280          /* max WBC width */ 
#define VO_WBC_MAX_HEIGHT       720          /* max WBC height */

//for driver macro define,refer to enum
#define CHANNEL_DHD_START  0 //DHD1
#define CHANNEL_DHD_END    0 //DHD1
#define CHANNEL_DSD_START  1 //DSD0
#define CHANNEL_DSD_END    1 //DSD0
...
typedef enum tagHAL_DISP_LAYER_E
{
    ...
    HAL_DISP_LAYER_VHD1 = 0 ,
    //HAL_DISP_LAYER_VHD2 = 2 ,    
    HAL_DISP_LAYER_VP   = 1,
    HAL_DISP_LAYER_VSD0 = 2 ,
    //HAL_DISP_LAYER_VSD1 = 2 ,
    //HAL_DISP_LAYER_VSD2 = 5 ,
    //HAL_DISP_LAYER_VSD3 = 6 ,
    //HAL_DISP_LAYER_VSD4 = 7 ,
    //HAL_DISP_LAYER_GFX0 = 3 ,    /* fb0 */  
    HAL_DISP_LAYER_GFX1 = 3 ,    /* fb1 */ 
    HAL_DISP_LAYER_HC0  = 4,     /* G2 is HC0  --- fb2 */ 
    //HAL_DISP_LAYER_HC1  = 7,     /* G3 is HC1  --- fb4 */ 
    HAL_DISP_LAYER_GFX4 = 5,     /* fb0 */ 
    //HAL_DISP_LAYER_WBC_G0 = 9,
    HAL_DISP_LAYER_WBC_G4 = 6,
    HAL_DISP_LAYER_WBC_D = 7,
    HAL_DISP_LAYER_TT   = 8,
...
#define LAYER_VHD_START  HAL_DISP_LAYER_VHD1  //VHD0
...
#define LAYER_GFX_START  HAL_DISP_LAYER_GFX1  //GFX1
