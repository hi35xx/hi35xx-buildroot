...
#define VO_VHD_BASE_ADDR   0x0
#define VO_VSD_BASE_ADDR   0x3000
#define VO_GFX_BASE_ADDR   0x9000
#define VO_HC_BASE_ADDR    0x9800
#define VO_WBC0_BASE_ADDR  0x8000
#define VO_WBC1_BASE_ADDR  0x8200
#define VO_DHD_BASE_ADDR   0xa000
#define VO_DSD_BASE_ADDR   0xa800
#define VHD_REG_LEN        0x1000
#define VSD_REG_LEN        0x1000
#define GFX_REG_LEN        0x200
#define HC_REG_LEN         0x200
#define WBC_REG_LEN        0x200
#define DHD_REG_LEN        0x400
#define DSD_REG_LEN        0x400

#define CHANNEL_DHD_START  0 //DHD0
#define CHANNEL_DHD_END    1 //DHD1
#define CHANNEL_DSD_START  2 //DSD0
#define CHANNEL_DSD_END    7 //DSD5

#define LAYER_VHD_START  0  //VHD0
#define LAYER_VHD_END    2  //VHD1
#define LAYER_VSD_START  3  //VSD0
#define LAYER_VSD_END    7  //VSD4
#define LAYER_GFX_START  8  //GFX0
#define LAYER_GFX_END    14 //HC1
#define LAYER_WBC_START  15 //WBC2
#define LAYER_WBC_END    15 //WBC2
...
typedef enum tagHAL_DISP_LAYER_E
{
    ...
    HAL_DISP_LAYER_VSD1 = 4 ,
    HAL_DISP_LAYER_VSD2 = 5 ,
    HAL_DISP_LAYER_VSD3 = 6 ,
    HAL_DISP_LAYER_VSD4 = 7 ,
    HAL_DISP_LAYER_GFX0 = 8 ,   
    HAL_DISP_LAYER_GFX1 = 9 ,   
    HAL_DISP_LAYER_GFX2 = 10,   
    HAL_DISP_LAYER_GFX3 = 11,   
    HAL_DISP_LAYER_GFX4 = 12,   
    HAL_DISP_LAYER_HC0  = 13,   
    HAL_DISP_LAYER_HC1  = 14,    
    HAL_DISP_LAYER_WBC2 = 15,
    HAL_DISP_LAYER_TT   = 16,
...
typedef enum tagHAL_DISP_INTFDATAFMT_E
{
    ...
    HAL_DISP_INTFDATAFMT_YCBCR420 = 0x1,
