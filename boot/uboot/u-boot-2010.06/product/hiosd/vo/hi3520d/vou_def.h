...
#define CHANNEL_DHD_END    0 //DHD0
#define CHANNEL_DSD_START  1 //DSD0
#define CHANNEL_DSD_END    2 //DSD1

#define LAYER_VHD_START  0  //VHD0
#define LAYER_VHD_END    1  //VSD0
#define LAYER_VSD_START  2  //VSD1
#define LAYER_VSD_END    2  //VSD1
#define LAYER_GFX_START  3  //GFX0
#define LAYER_GFX_END    6 //HC0
#define LAYER_WBC_START  7 //WBC
#define LAYER_WBC_END    7 //WBC
