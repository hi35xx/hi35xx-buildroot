...
#define   VO_BASE_ADDR  0x13020000
...
#define GRAPHIC_COMPRESS_FIRST_THRESHOLD   352
#define GRAPHIC_COMPRESS_SECOND_THRESHOLD  720
...
#define DEV_DHD_START	HAL_DISP_CHANNEL_DHD0
#define DEV_DHD_END		HAL_DISP_CHANNEL_DHD1
#define DEV_DSD_START	HAL_DISP_CHANNEL_DSD0
#define DEV_DSD_END		HAL_DISP_CHANNEL_DSD0
...
#define CHECK_HD_GFX(enLayer)	(HAL_DISP_LAYER_WBC_G0 == enLayer)||(HAL_DISP_LAYER_WBC_G4 == enLayer)
#define CHECK_WBC_GFX(enLayer)	(HAL_DISP_LAYER_WBC_G0 == enLayer)||(HAL_DISP_LAYER_WBC_G4 == enLayer)
...
typedef enum tagHAL_DISP_INTFPIXELFMT_E
{
    HAL_DISP_INTFPIXELFMT_YCBCR420   = 0x1,    
    HAL_DISP_INTFPIXELFMT_YCBCR444   = 0x0,
    HAL_DISP_INTFPIXELFMT_BUTT          
} HAL_DISP_INTFPIXELFMT_E;
...
typedef enum tagHAL_DISP_INTF_E
{
    ...
    HAL_DISP_INTF_DIGITAL = (0x01L<<8), 
    HAL_DISP_INTF_BUTT   = (0x01L<<9),
} HAL_DISP_INTF_E;
...
{
    HI_U8 u8Boundary_y[2];
    HI_U8 u8Boundary_cb[2];
    HI_U8 u8Boundary_cr[2];
