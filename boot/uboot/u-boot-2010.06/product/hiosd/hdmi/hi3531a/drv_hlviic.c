...
void HdmiHardwareReset(int iEnable)
{
    ...
    {        
        //bReset = HI_TRUE;
        RegSetBit(1, 9, HDMI_HARDWARE_RESET_ADDR);  /* 复位 */
        RegSetBit(1, 8, HDMI_HARDWARE_RESET_ADDR);  
    }
    else
    {        
        //bReset = HI_FALSE;
        RegSetBit(0, 9, HDMI_HARDWARE_RESET_ADDR);  /* 撤销复位 */
        RegSetBit(0, 8, HDMI_HARDWARE_RESET_ADDR);
    }
    RegSetBit(1, 2, HDMI_HARDWARE_RESET_ADDR); /* 开像素时钟  */ 
    RegSetBit(1, 0, HDMI_HARDWARE_RESET_ADDR);  /* 开总线时钟  */
