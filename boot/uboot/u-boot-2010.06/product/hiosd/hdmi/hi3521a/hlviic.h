...
#define HDMI_PHY_BASE_ADDR 0x13010000L

#define HDMI_TX_SLV0_ADDR_BASE   HDMI_PHY_BASE_ADDR
#define HDMI_TX_SLV1_ADDR_BASE   (HDMI_PHY_BASE_ADDR + 0x400L)

#define HDMI_HARDWARE_RESET_ADDR 0x12040038L
