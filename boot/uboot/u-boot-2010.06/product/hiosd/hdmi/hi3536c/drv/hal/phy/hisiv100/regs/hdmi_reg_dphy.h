...
/* Define the union U_HDMITX_DPHY_RST,ATTR:RW,ADDR:C,INIT:00000000,MASK:ffffffff,CMMNT:hdmi dphy software rest */
typedef union
{
    /* Define the struct bits */
    struct
...
/* add by q00352704, phy software rest use this reg on hi3536c */
