 ...
 ******************************************************************************
  ...
  Date          : 2015/08/13
  Author        : t00273561
  Modification  : add Hi3536CV100 HDMI Pin Multiplex @2017/04/01
*******************************************************************************/
...
#if defined(HDMI_CHIP_HI3536C)
        /* use phy reg to rest dphy, don't use CRG phy rst reg on hi3536c */
