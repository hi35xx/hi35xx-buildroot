...
/* phy specifications */
#if defined(CHIP_TYPE_hi3798mv200_a)
static PHY_HWSPEC_S s_stPhyHWSpecTab[] =
{
    {{ 25000, 100000}, { 0,  0,  0,  0, 22, 21, 21, 21,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x0d, PHY_RTERM_MODE_SINGLE, 0x2d, PHY_RTERM_MODE_SINGLE, 0x2d, PHY_RTERM_MODE_SINGLE, 0x2d}},
    {{100001, 165000}, { 0,  0,  0,  0, 22, 30, 30, 30,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x0d, PHY_RTERM_MODE_LOAD  , 0x4d, PHY_RTERM_MODE_LOAD  , 0x4d, PHY_RTERM_MODE_LOAD  , 0x4d}},
    {{165001, 340000}, { 0,  0,  0,  0, 22, 40, 40, 40,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x0d, PHY_RTERM_MODE_LOAD  , 0x4d, PHY_RTERM_MODE_LOAD  , 0x4d, PHY_RTERM_MODE_LOAD  , 0x4d}},
    {{340001, 600000}, { 0,  0,  0,  0, 22, 40, 40, 40,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x00, PHY_RTERM_MODE_LOAD  , 0xb0, PHY_RTERM_MODE_LOAD  , 0xb0, PHY_RTERM_MODE_LOAD  , 0xb0}},
};
...
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm|*/
    ...
    {{340001, 600000}, { 5,  0,  0,  0, 29, 43, 43, 43,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_SOURCE, 0x00, PHY_RTERM_MODE_LOAD  , 0xb0, PHY_RTERM_MODE_LOAD  , 0xb0, PHY_RTERM_MODE_LOAD  , 0xb0}},
};
#elif defined(CHIP_TYPE_hi3536cv100)
static PHY_HWSPEC_S s_stPhyHWSpecTab[] =
{
/****|-TmdsclkRange---||---DeIMain----||-iMain/0.5mA--||---DeIPre---- ||-iPre/0.25mA--||----------------DeRPre/Ohm------------------------||----------------RPre/Ohm-------------------------||------------------------RTerm--------------------------------------------------------------------------------------|**
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm|*/
    {{ 25000, 100000}, { 5,  0,  0,  0, 22, 25, 25, 25,  2,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20}},
    {{100001, 165000}, { 5,  5,  5,  5, 22, 23, 23, 23, 10, 25, 25, 25, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20}},
    {{165001, 340000}, { 9,  9,  9,  9, 22, 25, 25, 25, 30, 30, 30, 30, 20, 40, 40, 40, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20}},
...
HI_S32 HAL_HDMI_PhyTmdsSet(HDMI_PHY_TMDS_CFG_S *pstHdmiTmdsCfg)
{
    ...
    /* owx354332: must delay 500us after CRG register config finished. */
    msleep(1);
    /* set clk ratio */
