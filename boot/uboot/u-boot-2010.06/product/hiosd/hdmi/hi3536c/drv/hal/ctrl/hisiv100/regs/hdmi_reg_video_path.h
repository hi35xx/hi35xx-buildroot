...
/* Define the union U_TIMING_GEN_CTRL,ATTR:,ADDR:800,INIT:00000000,MASK:3ff,CMMNT:Timing Generator ¿ØÖÆ¼Ä´æÆ÷¡£*/
typedef union
{
...
/* Define the union U_HSYNC_TIMING_CONFIG0,ATTR:,ADDR:804,INIT:00638359,MASK:3ffffff,CMMNT:Ë®Æ½Ê±ÐòÅäÖÃ¼Ä´æÆ÷0¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HSYNC_TIMING_CONFIG1,ATTR:,ADDR:808,INIT:000202E0,MASK:3ffffff,CMMNT:Ë®Æ½Ê±ÐòÅäÖÃ¼Ä´æÆ÷1¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HSYNC_TIMING_CONFIG2,ATTR:,ADDR:80C,INIT:00000000,MASK:1fff,CMMNT:Ë®Æ½Ê±ÐòÅäÖÃ¼Ä´æÆ÷2¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VSYNC_TIMING_CONFIG0,ATTR:,ADDR:810,INIT:0000620C,MASK:ffffff,CMMNT:´¹Ö±Ê±ÐòÅäÖÃ¼Ä´æÆ÷0¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VSYNC_TIMING_CONFIG1,ATTR:,ADDR:814,INIT:0000F1EF,MASK:ffffff,CMMNT:´¹Ö±Ê±ÐòÅäÖÃ¼Ä´æÆ÷1¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VSYNC_TIMING_CONFIG2,ATTR:,ADDR:818,INIT:00000000,MASK:fff,CMMNT:´¹Ö±Ê±ÐòÅäÖÃ¼Ä´æÆ÷2¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VIDEO_PATH_CTRL,ATTR:,ADDR:830,INIT:00000000,MASK:1,CMMNT:Êä³ö±³¾°É«Ê¹ÄÜÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_PATTERN_GEN_CTRL,ATTR:,ADDR:840,INIT:00000000,MASK:7fff,CMMNT:enPattern Generator¿ØÖÆ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_SOLID_PATTERN_CONFIG,ATTR:,ADDR:844,INIT:1F8DC1F8,MASK:3fffffff,CMMNT:´¿É«patternÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MASK_PATTERN_CONFIG,ATTR:,ADDR:848,INIT:3FFFFFFF,MASK:3fffffff,CMMNT:mask patternÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_BAR_EXT_CONFIG,ATTR:,ADDR:84C,INIT:0007805A,MASK:3ffffff,CMMNT:colorbar/square pattern¿í¡¢¸ßÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A0,ATTR:,ADDR:850,INIT:3C3FC3FC,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ1ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A1,ATTR:,ADDR:854,INIT:21C87000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ2ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A2,ATTR:,ADDR:858,INIT:0008721C,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ3ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A3,ATTR:,ADDR:85C,INIT:00087000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ4ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A4,ATTR:,ADDR:860,INIT:21C0021C,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ5ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A5,ATTR:,ADDR:864,INIT:21C00000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ6ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A6,ATTR:,ADDR:868,INIT:0000021C,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ7ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_A7,ATTR:,ADDR:86C,INIT:00000000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ8ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B0,ATTR:,ADDR:870,INIT:00000000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ1ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B1,ATTR:,ADDR:874,INIT:0000021C,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ2ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B2,ATTR:,ADDR:878,INIT:21C00000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ3ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B3,ATTR:,ADDR:87C,INIT:21C0021C,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ4ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B4,ATTR:,ADDR:880,INIT:00087000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ5ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B5,ATTR:,ADDR:884,INIT:0008721C,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ6ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B6,ATTR:,ADDR:888,INIT:21C87000,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ7ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CBAR_PATTERN_B7,ATTR:,ADDR:88C,INIT:3C3FC3FC,MASK:3fffffff,CMMNT:Colorbar/square patternË®Æ½²ÊÌõ8ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_FORMAT_DET_CONFIG,ATTR:,ADDR:8B8,INIT:000000F0,MASK:ff,CMMNT:enFormat detector ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_FDET_STATUS,ATTR:,ADDR:8BC,INIT:00000000,MASK:7,CMMNT:enFormat detector ×´Ì¬¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_FDET_HORI_RES,ATTR:,ADDR:8C0,INIT:00000000,MASK:3ffffff,CMMNT:enFormat detector Ë®Æ½Ê±Ðò¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_FDET_VERT_RES,ATTR:,ADDR:8C4,INIT:00000000,MASK:3ffffff,CMMNT:enFormat detector ´¹Ö±Ê±Ðò¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_DITHER_CONFIG,ATTR:,ADDR:8EC,INIT:00000001,MASK:3f,CMMNT:Dither/RandÄ£¿éÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CLIP_CTRL,ATTR:,ADDR:8F8,INIT:00000001,MASK:3,CMMNT:ClipÄ£¿éÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CLIP_Y_CONFIG,ATTR:,ADDR:8FC,INIT:00FFF000,MASK:ffffff,CMMNT:CLIP Y·ÖÁ¿ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_CLIP_C_CONFIG,ATTR:,ADDR:900,INIT:00FFF000,MASK:ffffff,CMMNT:CLIP C·ÖÁ¿ÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_PXL_CAP_CTRL,ATTR:,ADDR:90C,INIT:00000000,MASK:77,CMMNT:ÏñËØ²¶»ñÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_PXL_CAP_POSITION,ATTR:,ADDR:910,INIT:00000000,MASK:3ffffff,CMMNT:ÏñËØ²¶»ñÎ»ÖÃÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_CTRL,ATTR:,ADDR:934,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF11,ATTR:,ADDR:938,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF12,ATTR:,ADDR:93C,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF13,ATTR:,ADDR:940,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF21,ATTR:,ADDR:944,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF22,ATTR:,ADDR:948,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF23,ATTR:,ADDR:94C,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF31,ATTR:,ADDR:950,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF32,ATTR:,ADDR:954,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_COEFF33,ATTR:,ADDR:958,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÏµÊýÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_INOFFSET_Y,ATTR:,ADDR:95C,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÊäÈëÆ«ÖÃÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_INOFFSET_CB,ATTR:,ADDR:960,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÊäÈëÆ«ÖÃÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_INOFFSET_CR,ATTR:,ADDR:964,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÊäÈëÆ«ÖÃÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_OUTOFFSET_Y,ATTR:,ADDR:968,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÊä³öÆ«ÖÃÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_OUTOFFSET_CB,ATTR:,ADDR:96C,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÊä³öÆ«ÖÃÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_MULTI_CSC_OUTOFFSET_CR,ATTR:,ADDR:970,INIT:00000000,MASK:ffffffff,CMMNT:Í¨ÓÃCSCÊä³öÆ«ÖÃÅäÖÃ¼Ä´æÆ÷¡£*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VIDEO_DWSM_CTRL,ATTR:,ADDR:980,INIT:00000008,MASK:ffffffff,CMMNT:±£Áô¼Ä´æÆ÷*/
typedef union
{
    /* Define the struct bits */
    struct
