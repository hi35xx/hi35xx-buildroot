...
HI_S32 HDMI_HDMITX_DPHY_RST_reg_rstSet(HI_U32 ureg_rst)
{
    ...
    HDMITXVerifyRegWrite(pu32RegAddr, o_hdmitx_dphy_rst.u32, "HDMITX_DPHY_RST");

    return HI_SUCCESS;
}

//******************************************************************************
//  Function    : HDMI_HDMITX_DPHY_RST_reg_rstGet
//  Description : Get the value of the member HDMITX_DPHY_RST.reg_dphy_srst_req
//  Return      : int: the value of HDMITX_DPHY_RST.reg_dphy_srst_req
//******************************************************************************
HI_S32 HDMI_HDMITX_DPHY_RST_reg_rstGet(HI_VOID)
{
    HI_U32 *pu32RegAddr = NULL;
    U_HDMITX_DPHY_RST o_hdmitx_dphy_rst;
    ...
    pu32RegAddr = (HI_U32*)&(gophdmi2tx_dphy_regAllReg->HDMITX_DPHY_RST.u32);
    o_hdmitx_dphy_rst.u32 = HDMITXRegRead(pu32RegAddr);
    return o_hdmitx_dphy_rst.bits.reg_dphy_srst_req;
}
