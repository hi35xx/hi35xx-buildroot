...
#define HDMI_VER_DATE     20170215
#define HDMI_VER_TIMES    1
...
typedef struct hiHDMI_APP_ATTR_S
{
    ...
    HDMI_QUANTIZATION_RANGE eOutCscQuantization; /**<CSC output quantization range 	HDMI_QUANTIZATION_RANGE_DEFAULT, HDMI_QUANTIZATION_RANGE_LIMITED, HDMI_QUANTIZATION_RANGE_FULL,>**/
