...
struct spi_nand_info hifmc_spi_nand_flash_table[] = {
	...
	/* Micron MT29F4G01ADA 4GBit */
	/* MT29F4G01ADA has 2 Die, need switching if we want to operation the
	 * second Die, this can not be supported by HiSilicon SPI Nand driver */
	/*{
		.name      = "MT29F4G01ADA",
		.id        = {0x2C, 0x36},
		.id_len    = 2,
