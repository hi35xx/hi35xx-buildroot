...
#define PERI_CRG45            	(0x12010000 + 0xb4)
#define USB2_HRST_REQ   	(1<<0)
#define USB2_PHY_SRST_REQ   	(1<<1)
#define USB2_PHY_PORT0_TREQ     (1<<2)
#define USB2_UTMI0_SRST_REQ	(1<<5)
#define USB2_PHY_CKEN		(1<<7)
#define USB2_OTG_PHY_SRST_REQ	(1<<8)

#define MISC_CTRL30             (0x12030000 + 0x78)
#define WORDINTERFACE		(1 << 0)
#define	SS_BURST4_EN		(1 << 7)
#define	SS_BURST8_EN		(1 << 8)
#define	SS_BURST16_EN		(1 << 9)
#define	OVRCUR_EN		(1 << 14)
#define	USB_DEVICE_EN		(1 << 31)

#define MISC_CTRL32             (0x12030000 + 0x80)
#define USB2_PHY_TEST_SRST_REQ  (1<<23)
