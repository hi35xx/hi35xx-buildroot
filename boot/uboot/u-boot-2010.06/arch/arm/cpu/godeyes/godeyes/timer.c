...
int timer_init (void)
{
	...
	__raw_writel(__raw_readl(REG_BASE_SCTL + REG_SC_CTRL) | (1<<16) | (1<<18) | (1<<20), REG_BASE_SCTL + REG_SC_CTRL);

	/*
	 *Under uboot, 0xffffffff is set to load register, and  Counting-fre = AXICLK/2/256.
	 * SO there will be  8000s left when counter decreased to 0 and timer won't roll back.
	 */
