...
#define TRAINING_SP                     0x2450
#define TRAINING_CHECK_VALUE            0x64647274
#define REG_BASE_SCTL                   0x20050000
#define TRAINING_TMP_BASE               0x82000000

#define DDRT_OPTION_REG                 0x20050020
#define DDRT_OPTION_CMD                 0xa5a5

#define TRAINING_ADDR                   0x2460
#define TRAINING_ADDR1                  0x2620
#define REG_CRG_BASE                    0x20030000
#define CRG_FERI_CRG56                  0x00e0
#define CRG_FERI_CRG20                  0x0050
