...
#define MIPS_REG_BASE			0x20120000
...
/******************PLL DDR CONFIG END************************************/
/* Communication Registers used by SMP */
/* Register storing address of which slaves running in kernel */
#define SMP_COREX_START_ADDR_REG        (SYS_CTRL_REG_BASE + 0x0134)
/* Slave bootloader running address after  master clear remap */
#define COREX_BOOT_ADDR                 0x83c00000
/* Communication cmd words*/
#define COREX_MOVE_CODE_CMD             0x9090  /* Slave start moving code */
#define COREX_MOVE_CODE_DONE            0xd050  /* Slave have moved code done */
#define COREX_RST_REG_BASE              CRG_REG_BASE
#define COREX_RST_REG                   0x28
...
#define _HI3535_V100                  (0x0035350100LL)
#define _HI3535_MASK                  (0xFFFFFFFFFFLL)
