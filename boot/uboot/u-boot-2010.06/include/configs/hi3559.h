 ...
 * Configuation settings for the hi3559 board.
 *
...
#ifndef __CONFIG_HI3559_H__
#define __CONFIG_HI3559_H__
...
/*-----------------------------------------------------------------------
 * for cpu/hi3559/start.S
 *----------------------------------------------------------------------*/
#define FMC_TEXT_ADRS			(FMC_MEM_BASE)
#define CP_STEP1_SIZE        0x4f00  /* copy 19.75KB for the first time */
...
/*-----------------------------------------------------------------------
 * for timer configuration (udelay)	cpu/hi3559/hi3559/timer.c
 * enable timer				board/hi3559/board.c
 *----------------------------------------------------------------------*/
...
#define CFG_BOOT_PARAMS			(MEM_BASE_DDR+0x08000000+0x0100)
...
/*-----------------------------------------------------------------------
 * for bootm linux
 * used in file  board/hi3559/board.c
 -----------------------------------------------------------------------*/
...
#define CONFIG_PRODUCTNAME		"hi3559"
