 ...
 * Configuation settings for the hi3556 board.
 *
...
#ifndef __CONFIG_HI3556_H__
#define __CONFIG_HI3556_H__
...
/*-----------------------------------------------------------------------
 * for timer configuration (udelay)	cpu/hi3556/hi3556/timer.c
 * enable timer				board/hi3556/board.c
 *----------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------
 * for bootm linux
 * used in file  board/hi3556/board.c
 -----------------------------------------------------------------------*/
...
#define CONFIG_PRODUCTNAME		"hi3556"
