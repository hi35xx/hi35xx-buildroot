 ...
 * Configuation settings for the godnet board.
 *
...
#ifndef __CONFIG_GODNET_H__
#define __CONFIG_GODNET_H__
 ...
 * SPI Flash Configuration
 -----------------------------------------------------------------------*/
#define CONFIG_HISFC_FLASH_GODNET 1
...
/*-----------------------------------------------------------------------
 * for timer configuration (udelay)	cpu/godnet/godnet/timer.c
*  enable timer				board/godnet/board.c
 -----------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------
 * for bootm linux
*  used in file  board/godnet/board.c
 -----------------------------------------------------------------------*/
...
#define CONFIG_PRODUCTNAME		"godnet"
