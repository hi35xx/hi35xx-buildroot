...
/*
 * (C) Copyright 2016-2017, HISILICON
 *
...
#ifndef __CONFIG_HI3516AV200_H__
#define __CONFIG_HI3516AV200_H__
...
/*-----------------------------------------------------------------------
 * for timer configuration (udelay)	cpu/hi3516av200/hi3516av200/timer.c
 * enable timer				board/hi3516av200/board.c
 *----------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------
 * for bootm linux
 * used in file  board/hi3516av200/board.c
 -----------------------------------------------------------------------*/
...
#define CONFIG_PRODUCTNAME		"hi3516av200"
...
#define CONFIG_ARCH_HI3516AV200	1
