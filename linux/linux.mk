...
define LINUX_KCONFIG_FIXUP_CMDS
	$(if $(BR2_LINUX_KERNEL_EXT_WIFI),
		$(call KCONFIG_ENABLE_OPT,CONFIG_HOSTAP,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_HOSTAP_FIRMWARE,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_HOSTAP_FIRMWARE_NVRAM,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_HOSTAP_PLX,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_HOSTAP_PCI,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_HOSTAP_CS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_CFG80211_DEBUGFS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_LIB80211_CRYPT_WEP,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_LIB80211_CRYPT_CCMP,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_LIB80211_CRYPT_TKIP,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211_LEDS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211_DEBUGFS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_WEXT_SPY,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_WIRELESS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_WIRELESS_EXT,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_WEXT_CORE,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_WEXT_PROC,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_WEXT_PRIV,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_CFG80211,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_NL80211_TESTMODE,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_CFG80211_DEFAULT_PS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_CFG80211_WEXT,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_WIRELESS_EXT_SYSFS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_LIB80211,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211_HAS_RC,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211_RC_MINSTREL,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211_RC_MINSTREL_HT,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211_RC_DEFAULT_MINSTREL,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_MAC80211_MESH,$(@D)/.config)
		$(call KCONFIG_SET_OPT,CONFIG_MAC80211_RC_DEFAULT,"minstrel_ht",$(@D)/.config))
