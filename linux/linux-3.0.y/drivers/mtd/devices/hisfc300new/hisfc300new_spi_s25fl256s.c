...
*/
	if (enable) {
		hisfc300_write(host, HISFC300_CMD_INS, SPI_CMD_BRWR);
		hisfc300_write(host, HISFC300_CMD_DATABUF0, SPI_EN4B_VALUE);
	} else {
		hisfc300_write(host, HISFC300_CMD_INS, SPI_CMD_BRWR);
		hisfc300_write(host, HISFC300_CMD_DATABUF0, SPI_EX4B_VALUE);
	}
