...
static int spi_gd25qxxx_qe_enable(struct hisfc_spi *spi)
{
	...
	hisfc300_write(host, HISFC300_CMD_INS, SPI_CMD_WRSR1);
	hisfc300_write(host, HISFC300_CMD_DATABUF0, qe_op1);
	...
	hisfc300_write(host, HISFC300_CMD_INS, SPI_CMD_WRSR2);
	hisfc300_write(host, HISFC300_CMD_DATABUF0, qe_op2);
