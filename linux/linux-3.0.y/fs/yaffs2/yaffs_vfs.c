...
struct dentry *yaffs_mount(struct file_system_type *fs, int flag,
		const char *dev_name, void *data)
{
	return mount_bdev(fs, flag, dev_name, data,
...
struct dentry *yaffs2_mount(struct file_system_type *fs, int flag,
		const char *dev_name, void *data)
{
	return mount_bdev(fs, flag, dev_name, data,
