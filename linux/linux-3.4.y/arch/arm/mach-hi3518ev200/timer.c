...
#  undef CONFIG_HAVE_SP804_LOCAL_TIMER_HI3518EV200
#endif
/*****************************************************************************/
...
#ifdef CONFIG_HAVE_SP804_LOCAL_TIMER_HI3518EV200
/*****************************************************************************/
...
hi3518ev200_local_timer_setup(struct clock_event_device *evt)
{
...
static void hi3518ev200_local_timer_stop(struct clock_event_device *evt)
{
...
static struct local_timer_ops hi3518ev200_timer_tick_ops __cpuinitdata = {
	.setup	= hi3518ev200_local_timer_setup,
	.stop	= hi3518ev200_local_timer_stop,
};

static void __init hi3518ev200_local_timer_init(void)
{
	...
	local_timer_register(&hi3518ev200_timer_tick_ops);
}
#endif /* CONFIG_HAVE_SP804_LOCAL_TIMER_HI3518EV200 */

/*****************************************************************************/
static void __init hi3518ev200_timer_init(void)
{
...
struct sys_timer hi3518ev200_sys_timer = {
	.init = hi3518ev200_timer_init,
};
