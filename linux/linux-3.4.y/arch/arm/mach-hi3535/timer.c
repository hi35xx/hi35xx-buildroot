...
static struct hi_timer_t hi_timer[] = {
	...
	HI_TIMER(4, INTNR_TIMER_2, REG_BASE_TIMER2),
	HI_TIMER(5, INTNR_TIMER_2, REG_BASE_TIMER2 + 0x20),
	HI_TIMER(6, INTNR_TIMER_3, REG_BASE_TIMER3),
	HI_TIMER(7, INTNR_TIMER_3, REG_BASE_TIMER3 + 0x20),
};
...
static int __cpuinit hi3535_local_timer_setup(struct clock_event_device *evt)
{
...
static void hi3535_local_timer_stop(struct clock_event_device *evt)
{
...
static struct local_timer_ops hi3535_timer_tick_ops __cpuinitdata = {
	.setup	= hi3535_local_timer_setup,
	.stop	= hi3535_local_timer_stop,
};

static void __init hi3535_local_timer_init(void)
{
	...
	local_timer_register(&hi3535_timer_tick_ops);
}
...
struct sys_timer hi3535_sys_timer = {
	.init = hi3535_timer_init,
};
