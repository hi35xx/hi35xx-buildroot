/* linux/drivers/spi/spidev_info-hi3518ev200.c
 *
 ...
 */
static struct spi_board_info hi3518ev200_spidev_info[] = {
	{
		.modalias       = "spidev",
		.bus_num        = 0,
		.chip_select    = 0,
...
{
	*info = hi3518ev200_spidev_info;

	return ARRAY_SIZE(hi3518ev200_spidev_info);
}
