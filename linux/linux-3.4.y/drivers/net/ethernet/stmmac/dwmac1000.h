...
enum flow_ctrl_rfa {
	DMA_CONTROL_RFA_FULL_MINUS_1KB = 0x00000000,
	DMA_CONTROL_RFA_FULL_MINUS_2KB = 0x00000200,
	DMA_CONTROL_RFA_FULL_MINUS_3KB = 0x00000400,
	DMA_CONTROL_RFA_FULL_MINUS_4KB = 0x00000600,
	DMA_CONTROL_RFA_FULL_MINUS_5KB = 0x00800000,
	DMA_CONTROL_RFA_FULL_MINUS_6KB = 0x00800200,
	DMA_CONTROL_RFA_FULL_MINUS_7KB = 0x00800400,
};

enum flow_ctrl_rfd {
	DMA_CONTROL_RFD_FULL_MINUS_1KB = 0x00000000,
	DMA_CONTROL_RFD_FULL_MINUS_2KB = 0x00000800,
	DMA_CONTROL_RFD_FULL_MINUS_3KB = 0x00001000,
	DMA_CONTROL_RFD_FULL_MINUS_4KB = 0x00001800,
	DMA_CONTROL_RFD_FULL_MINUS_5KB = 0x00400000,
	DMA_CONTROL_RFD_FULL_MINUS_6KB = 0x00400800,
	DMA_CONTROL_RFD_FULL_MINUS_7KB = 0x00401000,
};
