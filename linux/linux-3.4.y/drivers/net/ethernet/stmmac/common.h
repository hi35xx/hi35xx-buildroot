...
/* Threshold for activating flow control, default: Full - 2KB */
#define RFA_VALUE	2
/* Threshold for deactivating flow control, default: Full - 4KB */
#define RFD_VALUE	4
...
#else
#define DMA_BUFFER_SIZE (ETH_FRAME_LEN + 256)
#endif

#define RX_BUFFER_BUS_ALIGN	16
#define DMA_BUFFER_DESC_SIZE	((DMA_BUFFER_SIZE - RX_BUFFER_BUS_ALIGN) & \
				~(RX_BUFFER_BUS_ALIGN - 1))
...
struct stmmac_desc_ops {
	...
	int (*rx_status) (void *data, struct stmmac_extra_stats *x,
			  struct dma_desc *p);
	void (*set_tx_igmp) (struct dma_desc *p);
	void (*clean_tx_igmp) (struct dma_desc *p);
