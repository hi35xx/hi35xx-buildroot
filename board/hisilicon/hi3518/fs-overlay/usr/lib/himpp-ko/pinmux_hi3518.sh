...
net_rmii_mode()
{
	...
	# Note: MII_TXD2 and MII_TXD3 are only needed for MII

	# devmem  0x200f0048 32  0x1
	devmem  0x200f0048 32  0x0
	# devmem  0x200f004C 32  0x1
	devmem  0x200f004C 32  0x0
	...
	# Note: muxctrl_reg28 sets the function of EPHY_CLK pin.
	# The original script set the pin to the EPHY_CLK but it only works if it is set to GPIO1_3
	# see: http://mrfdsp.com/mipi-csi2/Hi3518-Hisilicon.pdf
	# The clock is instead provided by RMII_CLK
