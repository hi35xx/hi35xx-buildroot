...
HIMPP_HI3518V100_SOURCE = himpp-hi3518v100/hi3518v100-mpp2-$(HIMPP_HI3518V100_VERSION).tgz
HIMPP_HI3518V100_INSTALL_STAGING = YES
HIMPP_HI3518V100_DEPENDENCIES = linux
...
HIMPP_HI3518V100_MAKE_OPTS += MPP_PATH=$(@D)
HIMPP_HI3518V100_MAKE_OPTS += SENSOR_TYPE=$(SENSOR_TYPE)

define HIMPP_HI3518V100_EXTRACT_CMDS
	mkdir -p $(@D)
	$(TAR) -zxf $(HIMPP_HI3518V100_DL_DIR)/$(HIMPP_HI3518V100_SOURCE) \
		--strip-components=2 -C $(@D)
endef

define himpp_build
	( cd $(@D)/$(1) && $(MAKE1) $(HIMPP_HI3518V100_MAKE_OPTS) ) || exit 1;
endef
...
define HIMPP_HI3518V100_INSTALL_STAGING_CMDS
	mkdir -p $(STAGING_DIR)$(HIMPP_PREFIX)/include/hi3518v100mpp
	mkdir -p $(STAGING_DIR)$(HIMPP_PREFIX)/lib
	# install header files
	cp -a $(@D)/include/* \
	    $(STAGING_DIR)$(HIMPP_PREFIX)/include/hi3518v100mpp/
...
define HIMPP_HI3518V100_INSTALL_INIT_SYSV
	$(INSTALL) -m 0755 -D package/himpp/himpp-hi3518v100/S25himpp \
